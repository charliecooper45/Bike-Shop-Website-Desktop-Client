...
public class LoginWindow extends AbstractClientWindow {
	...
	protected void init() {
		...
		Utils.setGBC(gbc, 3, 1, 2, 1, GridBagConstraints.NONE);
		add(loginButton, gbc);

		// error label
		gbc.anchor = GridBagConstraints.CENTER;
		gbc.weighty = 0.1;
		Utils.setGBC(gbc, 4, 1, 2, 1, GridBagConstraints.NONE);
		...
		gbc.weighty = 1;
		passwordLabel = new JLabel("<html><a href=\"\">"
				+ "Forgotten Password?" + "</a></html>");
		...
		Utils.setGBC(gbc, 5, 1, 2, 1, GridBagConstraints.NONE);
